...
- **Verified is a real answer.** Some claims are well-supported. A proposal with benchmarks, cited sources, and honest ranges is doing it right. Acknowledge good epistemic hygiene. Aim for at least 1 of your 5 findings to be `Verified: yes` — a claim that earned its confidence. A run with zero verifications either means the artifact is genuinely unsupported, or you're being unfairly skeptical. Check yourself.
